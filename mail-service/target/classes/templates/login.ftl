    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="">
            ...
            <div>
                ...
                <img class="admin-captcha" width="90" height="30" src="http://localhost:8080/mail/captcha/image" onclick='this.src=this.src+"?"+Math.random()'>
            </div>
            <button class="layui-btn admin-button" lay-submit="" lay-filter="login" id="login">登 陆</button>
        </form>
    </div>
</div>
